...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _handleLogin() async {
    ...
    try {
      final dio = Dio();
      final response = await dio.post('${ApiConfig.baseUrl}/auth/login', data: {
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: _buildLoginForm(roleColor, roleData),
                  ),
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(color: AppTheme.accentCyan.withOpacity(0.3), blurRadius: 30, spreadRadius: 5),
            ],
          ),
          child: ClipOval(
            child: Padding(
  ...
  Widget _buildLoginForm(Color roleColor, Map<String, dynamic> roleData) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      ...
      children: [
        ...
        const Text('Command Center Access', style: TextStyle(color: AppTheme.textPrimary, fontSize: 20, fontWeight: FontWeight.bold)),
        const SizedBox(height: 24),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(entry.value['icon'] as IconData, color: isSelected ? rColor : AppTheme.textSecondary, size: 18),
                  ),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: IconButton(
              icon: Icon(_obscurePassword ? Icons.visibility_off : Icons.visibility, color: AppTheme.textSecondary, size: 22),
          ...
          child: ElevatedButton(
            ...
            child: _isLoading
                ...
                : Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(roleData['icon'] as IconData, color: AppTheme.background, size: 22),
